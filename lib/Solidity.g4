...
stateVariableDeclaration:
	typeName (Public | Internal | Private | Constant)* identifier (
		'=' expression
	)? ';';
...
structVariableDeclaration: variableDeclaration ';';
...
indexedParameter:
	typeName (storageLocation | Indexed)* identifier?;
...
unnamedParameter: typeName storageLocation?;
...
assemblyCall:
	('return' | 'address' | elementaryTypeName | Identifier) (
...
Identifier: (IdFirstLetter IdCentralPart* | 'from');
fragment IdFirstLetter: [a-zA-Z$_];
fragment IdCentralPart: [a-zA-Z0-9$_];
